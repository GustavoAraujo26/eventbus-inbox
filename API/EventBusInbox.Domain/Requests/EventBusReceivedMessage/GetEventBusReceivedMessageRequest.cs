...
namespace EventBusInbox.Domain.Requests.EventBusReceivedMessage
{
    ...
    public class GetEventBusReceivedMessageRequest : IRequest<AppResponse<GetEventBusReceivedMessageResponse>>
    {
        ...
        /// </summary>
        /// <returns></returns>
        public AppResponse<GetEventBusReceivedMessageRequest> Validate() =>
            AppResponse<GetEventBusReceivedMessageRequest>.ValidationResponse(new GetEventBusReceivedMessageValidation().Validate(this));
    }
}
